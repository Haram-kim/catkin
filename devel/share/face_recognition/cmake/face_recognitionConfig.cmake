...
if("TRUE" STREQUAL "TRUE")
  set(face_recognition_SOURCE_PREFIX /home/haram/catkin_ws/src/procrob_functional)
  set(face_recognition_DEVEL_PREFIX /home/haram/catkin_ws/devel)
  ...
  set(face_recognition_INSTALL_PREFIX /home/haram/catkin_ws/install)
...
if(NOT "/home/haram/catkin_ws/devel/include " STREQUAL " ")
  set(face_recognition_INCLUDE_DIRS "")
  set(_include_dirs "/home/haram/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "http://ros.org/wiki/face_recognition " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/face_recognition' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Pouyan Ziafati (Author) <pouyan.ziafati@uni.lu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/haram/catkin_ws/src/procrob_functional/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/haram/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(face_recognition_EXPORTED_TARGETS "face_recognition_generate_messages_cpp;face_recognition_generate_messages_eus;face_recognition_generate_messages_lisp;face_recognition_generate_messages_nodejs;face_recognition_generate_messages_py")
